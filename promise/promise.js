...
대세 온라인 쇼핑몰 중 하나인 코드잇몰(codeitmall)은 사업을 더 확장하기 위해서 올해 여름에 신입사원 채용을 진행했습니다. 
그리고 이제 최종 인터뷰 결과가 나와서 그 중에서 합격한 사람들의 정보 그러니까 신입 직원들의 정보를, 기존의 직원 정보에 추가하려고 하는데요.

최종 인터뷰 결과 URL: https://learn.codeit.kr/api/interviews/summer
...
직원 정보 URL: https://learn.codeit.kr/api/members"

이 URL을 사용해서 기존의 직원 정보에 신입 직원들의 정보를 추가하고, 올해의 새 직원 명단을 출력해보세요. 
참고로 이전에 직원 정보를 추가하기 위해 POST 리퀘스트를 보낼 때는 객체 하나를 보내서 하나의 직원 정보를 추가했지만, 
여러 직원 정보가 담긴 배열을 보내서 모두 추가하는 것도 가능합니다. 이 사실을 기억하고 코드의 빠진 부분을 채워보세요.
